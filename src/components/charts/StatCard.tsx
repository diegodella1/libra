export function StatCard({ value, label, context }: { value: string; label: string; context?: string }) {
  return (
    <div className="bg-white rounded-xl border border-ink-200 p-5 text-center hover:border-gold-400 transition-colors">
      <p className="text-2xl sm:text-3xl font-bold text-gold-700 font-mono">{value}</p>
